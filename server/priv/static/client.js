...
function main() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError("let_assert", FILEPATH, "client", 30, "main", "Pattern match failed, no pattern matched the value.", { value: $, start: 784, end: 843, pattern_start: 795, pattern_end: 800 });
  }
  return;
}
